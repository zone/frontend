...
This package provides Zone's JavaScript style guide for Vue as an extensible shared config. It installs and extends [Zones base config](https://github.com/zone/frontend/tree/master/packages/eslint-config-zone), see this package for additional installation details.
